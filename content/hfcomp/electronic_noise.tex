...
\begin{itemize}
    ...
    \item \textbf{(Normalized) Error Function:}
        \begin{equation*}
            p(0<u<u_1) = \int\limits_0^{u_1} p^*(u)\mathrm{d}u = \Phi^*\left(\dfrac{u_1}{\tilde{u}}\right) \approx \dfrac{1}{2} - \dfrac{\exp(-\frac{1}{2}\frac{u_1^2}{\tilde{u}^2})}{\sqrt{2\pi}(u_1/\tilde{u})}
        \end{equation*}
...
\todo{Add formulas for noise power and noise circuit}
...
\begin{itemize}
    ...
    \item Assume input noise sources:
        \begin{align*}
            ...
            &|\tilde{I}_{N}|^2 = 4k_B T_0 R_n \Delta f,\\
    ...
    \item Circles of constant noise figure:\\
        \todo{Add formulas and diagram here.}
\end{itemize}
