...
\begin{itemize}
    ...
    \end{itemize}
\item \textit{Rules of thumb} for Emitter (Base) Circuit:
    \begin{align*}
        &U_{E,DC} \approx \dfrac{U_{Bat}}{3..6}, \quad U_{BE,DC} \approx \SI{0.7}{V},\\
        &I_{RX,DC} \approx 10 \, I_{B,DC}\text{ (base feed current)}
    \end{align*}
