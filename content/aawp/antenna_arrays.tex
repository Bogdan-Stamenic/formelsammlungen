...
\begin{itemize}
    ...
    \item \textbf{Array of Two identical Antenna Elements}:
        \begin{align*}
            ...
            &\delta = \psi - \beta d\,\sin\vartheta \cos\varphi, \quad \beta = \dfrac{2\pi}{\lambda}
        \end{align*}
    ...
    \item Directivity of a general linear array:
        \begin{align*}
            &D = \dfrac{\left|\dfrac{\sin\left( M\dfrac\xi2 \right)}{M\sin\left( \dfrac\xi2 \right)}\right|^2}{\dfrac{1}{M} + \dfrac{1}{M^2} \sum\limits^{M-1}_{m=1}\dfrac{(M-m)}{mkd} 2\cos\left(m\Delta\phi\right)\sin(mkd)}\\
