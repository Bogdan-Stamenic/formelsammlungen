...
\begin{itemize}
    ...
    \item Two different far-field approximations:\\
        ...
        \item Approximating in the far-field, we get:
            ...
            \end{align*}
        \item Spherical field components in the Far-field; \textbf{electric current source} $\vec{J}$:\\
            \fbox{%
            \parbox{.3\textwidth}{%
            \begin{align*}
                &H_{r1}=0, &E_{r1}=0,\\
        ...
        \item Spherical field components in the Far-field; \textbf{magnetic current source} $\vec{M}$:\\
            \fbox{%
            \parbox{.3\textwidth}{%
            \begin{align*}
                &E_{r2}=0, &H_{r2}=0,\\
